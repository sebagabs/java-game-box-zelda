...
public class ZeldaMapMakerState extends State {
    ...
    public void tick() {
        ...
        if (handler.getKeyManager().keyJustPressed(KeyEvent.VK_R)){
            ...
            int r2 = rand.nextInt(42);
            if (linking){
                handler.getDisplayScreen().confirm("Random tile from the list to be the one selected");
            }else {
                switch (selector) {
                    case 0:
                ...
                switch (selector) {
                    case 0:
                    	if(counter<=29) {
                    	 ...
                    	 if(counter==14 && handler.getKeyManager().keyJustPressed(KeyEvent.VK_B)) {
                            handler.getDisplayScreen().confirm("You are already in the middle");
                    	}
                    ...
                    default:
                    	 ...
                    	 if(counter==20 && handler.getKeyManager().keyJustPressed(KeyEvent.VK_B)) {
                            handler.getDisplayScreen().confirm("You are already in the middle");
                    	}
