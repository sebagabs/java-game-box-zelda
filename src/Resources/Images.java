...
public class Images {
	...
	public static BufferedImage[] zeldaEnemyFrames;
	...
	//link attack animation-->link_116,116,116_gray.png
	public static BufferedImage[] wsAttackUp;
	public static BufferedImage[] wsAttackDown;
	public static BufferedImage[] wsAttackLeft;
	public static BufferedImage[] wsAttackRight;
	...
	public Images() {
		...
		zeldaLinkFrames = new BufferedImage[24];

		bouncyEnemyFrames = new BufferedImage[2];
		octorokEnemyFrames = new BufferedImage[8];

		// new additions
		//link attack animation-->link_116,116,116_gray.png
		//		wsAttackUp=new BufferedImage[4];
		//		wsAttackDown=new BufferedImage[4];
		//		wsAttackLeft=new BufferedImage[4];
		//		wsAttackRight=new BufferedImage[4];
		...
		try {
			...
			//attackup
			zeldaLinkFrames[8]= zeldaLinkSpriteSheet.crop(1,97, 16, 28);
			zeldaLinkFrames[9]= zeldaLinkSpriteSheet.crop(18,97, 16, 28);
			zeldaLinkFrames[10]= zeldaLinkSpriteSheet.crop(35,97, 16, 28);
			zeldaLinkFrames[11]= zeldaLinkSpriteSheet.crop(52,97, 16, 28);
			//down
			zeldaLinkFrames[12]=zeldaLinkSpriteSheet.crop(1,47, 16, 28);
			zeldaLinkFrames[13]=zeldaLinkSpriteSheet.crop(18,47, 16, 28);
			zeldaLinkFrames[14]=zeldaLinkSpriteSheet.crop(35,47, 16, 28);
			zeldaLinkFrames[15]=zeldaLinkSpriteSheet.crop(52,47, 16, 28);
			//right
			zeldaLinkFrames[16]=zeldaLinkSpriteSheet.crop(1,78, 16, 15);
			zeldaLinkFrames[17]=zeldaLinkSpriteSheet.crop(18,78, 27, 15);
			zeldaLinkFrames[18]=zeldaLinkSpriteSheet.crop(46,78, 23, 15);
			zeldaLinkFrames[19]=zeldaLinkSpriteSheet.crop(70,77, 23, 16);
			//left
			zeldaLinkFrames[20]=Images.flipHorizontal(zeldaLinkFrames[16]);
			zeldaLinkFrames[21]=Images.flipHorizontal(zeldaLinkFrames[17]);
			zeldaLinkFrames[22]=Images.flipHorizontal(zeldaLinkFrames[18]);
			zeldaLinkFrames[23]=Images.flipHorizontal(zeldaLinkFrames[19]);
			...
			//wooden sword attack animations

			//									//up
			//			wsAttackUp[0]= zeldaLinkSpriteSheet.crop(1,97, 16, 28);
			//			wsAttackUp[1]= zeldaLinkSpriteSheet.crop(18,97, 16, 28);
			//			wsAttackUp[2]= zeldaLinkSpriteSheet.crop(35,97, 16, 28);
			//			wsAttackUp[3]= zeldaLinkSpriteSheet.crop(52,97, 16, 28);
			//			
			//			
			//									//down
			//			wsAttackDown[0]=zeldaLinkSpriteSheet.crop(1,47, 16, 28);
			//			wsAttackDown[1]=zeldaLinkSpriteSheet.crop(18,47, 16, 28);
			//			wsAttackDown[2]=zeldaLinkSpriteSheet.crop(35,47, 16, 28);
			//			wsAttackDown[3]=zeldaLinkSpriteSheet.crop(52,47, 16, 28);
			//			
			//									//right
			//			wsAttackRight[0]=zeldaLinkSpriteSheet.crop(1,78, 16, 15);
			//			wsAttackRight[1]=zeldaLinkSpriteSheet.crop(18,78, 27, 15);
			//			wsAttackRight[2]=zeldaLinkSpriteSheet.crop(46,78, 23, 15);
			//			wsAttackRight[3]=zeldaLinkSpriteSheet.crop(70,77, 23, 16);
			//			
			//									//left
			//			wsAttackLeft[0]=Images.flipHorizontal(wsAttackRight[0]);
			//			wsAttackLeft[1]=Images.flipHorizontal(wsAttackRight[1]);
			//			wsAttackLeft[2]=Images.flipHorizontal(wsAttackRight[2]);
			//			wsAttackLeft[3]=Images.flipHorizontal(wsAttackRight[3]);
			...
			//left
			octorokEnemyFrames[2] = EnemyOverwoldSpriteSheet.crop(35, 11, 16, 16);
			octorokEnemyFrames[3] = EnemyOverwoldSpriteSheet.crop(52, 11, 16, 16);
			//right
			octorokEnemyFrames[4] = Images.flipHorizontal(octorokEnemyFrames[2]);
			octorokEnemyFrames[5] = Images.flipHorizontal(octorokEnemyFrames[3]);
			//up
			octorokEnemyFrames[6] = EnemyOverwoldSpriteSheet.crop(1, 76, 16, 16);
			octorokEnemyFrames[7] = EnemyOverwoldSpriteSheet.crop(18, 76, 16, 16);
			...
			// new additions
			//Ui.Backgrounds.Zelda-->npc.png
			npcImage=ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/npc.png"));
			...
			//crops:
			hearts[0]=itemSpriteSheet.crop(0, 0, 7, 8);//full heart
			hearts[1]=itemSpriteSheet.crop(8, 0, 7, 8);//half heart
			hearts[2]=itemSpriteSheet.crop(16, 0, 7, 8);//empty heart

			woodenSword=itemSpriteSheet.crop(104, 0, 7, 16);
